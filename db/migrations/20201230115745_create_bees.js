...
exports.up = function(knex) {
    return knex.schema.createTable('bees', t => {
        ...
        t.boolean('todo').defaultTo(1).comment('1 shows done todos in calendar 0 not');
        t.boolean('sound').defaultTo(1).comment('If user wants to sounds when action is saved succefully or on error etc');
        t.boolean('tablexscroll').defaultTo(1).comment('If user want to allow horizontal scrolling in tables');
