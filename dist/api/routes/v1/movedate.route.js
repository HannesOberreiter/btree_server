...
const movedate_controller_js_1 = __importDefault(require("../../controllers/movedate.controller.js"));
...
function routes(instance, _options, done) {
    ...
    }, movedate_controller_js_1.default.get);
    server.post('/', {
    ...
    }, movedate_controller_js_1.default.post);
    server.patch('/', {
        preHandler: guard_middleware_js_1.Guard.authorize([constants_config_js_1.ROLES.admin, constants_config_js_1.ROLES.user]),
        schema: {
            body: zod_1.z.object({
    ...
    }, movedate_controller_js_1.default.patch);
    server.patch('/date', {
        preHandler: guard_middleware_js_1.Guard.authorize([constants_config_js_1.ROLES.admin, constants_config_js_1.ROLES.user]),
        schema: {
            body: zod_1.z.object({
    ...
    }, movedate_controller_js_1.default.updateDate);
    ...
    }, movedate_controller_js_1.default.batchDelete);
    ...
    }, movedate_controller_js_1.default.batchGet);
    done();
}
