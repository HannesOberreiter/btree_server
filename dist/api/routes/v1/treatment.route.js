...
const treatment_controller_js_1 = __importDefault(require("../../controllers/treatment.controller.js"));
...
function routes(instance, _options, done) {
    ...
    }, treatment_controller_js_1.default.get);
    server.post('/', {
        ...
        schema: {
            body: zod_1.z
                ...
                interval: zod_1.z.number().min(0).max(365),
                repeat: zod_1.z.number().min(0).max(15),
            })
                .passthrough(),
        },
    }, treatment_controller_js_1.default.post);
    server.patch('/', {
        preHandler: guard_middleware_js_1.Guard.authorize([constants_config_js_1.ROLES.admin, constants_config_js_1.ROLES.user]),
        schema: {
            body: zod_1.z.object({
    ...
    }, treatment_controller_js_1.default.patch);
    server.patch('/status', {
        preHandler: guard_middleware_js_1.Guard.authorize([constants_config_js_1.ROLES.admin, constants_config_js_1.ROLES.user]),
        schema: {
            body: zod_1.z.object({
    ...
    }, treatment_controller_js_1.default.updateStatus);
    server.patch('/date', {
        preHandler: guard_middleware_js_1.Guard.authorize([constants_config_js_1.ROLES.admin, constants_config_js_1.ROLES.user]),
        schema: {
            body: zod_1.z.object({
    ...
    }, treatment_controller_js_1.default.updateDate);
    ...
    }, treatment_controller_js_1.default.batchDelete);
    ...
    }, treatment_controller_js_1.default.batchGet);
    done();
}
