...
const rearing_type_controller_js_1 = __importDefault(require("../../controllers/rearing_type.controller.js"));
...
function routes(instance, _options, done) {
    ...
    }, rearing_type_controller_js_1.default.get);
    server.patch('/', {
    ...
    }, rearing_type_controller_js_1.default.patch);
    server.post('/', {
        preHandler: guard_middleware_js_1.Guard.authorize([constants_config_js_1.ROLES.admin, constants_config_js_1.ROLES.user]),
        schema: {
            body: zod_1.z
    ...
    }, rearing_type_controller_js_1.default.post);
    ...
    }, rearing_type_controller_js_1.default.batchDelete);
    ...
    }, rearing_type_controller_js_1.default.batchGet);
    done();
}
