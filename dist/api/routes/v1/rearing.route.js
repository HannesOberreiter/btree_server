...
const rearing_controller_js_1 = __importDefault(require("../../controllers/rearing.controller.js"));
...
function routes(instance, _options, done) {
    ...
    }, rearing_controller_js_1.default.get);
    server.patch('/', {
    ...
    }, rearing_controller_js_1.default.patch);
    server.post('/', {
        preHandler: guard_middleware_js_1.Guard.authorize([constants_config_js_1.ROLES.admin, constants_config_js_1.ROLES.user]),
        schema: {
            body: zod_1.z
                .object({
                detail_id: zod_1.z.number(),
                type_id: zod_1.z.number(),
                date: zod_1.z.string(),
            })
                .passthrough(),
        },
    }, rearing_controller_js_1.default.post);
    server.patch('/date', {
        preHandler: guard_middleware_js_1.Guard.authorize([constants_config_js_1.ROLES.admin, constants_config_js_1.ROLES.user]),
        schema: {
            body: zod_1.z.object({
    ...
    }, rearing_controller_js_1.default.updateDate);
    ...
    }, rearing_controller_js_1.default.batchDelete);
    ...
    }, rearing_controller_js_1.default.batchGet);
    done();
}
