...
const checkup_controller_js_1 = __importDefault(require("../../controllers/checkup.controller.js"));
...
function routes(instance, _options, done) {
    ...
    }, checkup_controller_js_1.default.get);
    server.post('/', {
    ...
    }, checkup_controller_js_1.default.post);
    server.patch('/', {
        preHandler: guard_middleware_js_1.Guard.authorize([constants_config_js_1.ROLES.admin, constants_config_js_1.ROLES.user]),
        schema: {
            body: zod_1.z.object({
    ...
    }, checkup_controller_js_1.default.patch);
    server.patch('/status', {
        preHandler: guard_middleware_js_1.Guard.authorize([constants_config_js_1.ROLES.admin, constants_config_js_1.ROLES.user]),
        schema: {
            body: zod_1.z.object({
    ...
    }, checkup_controller_js_1.default.updateStatus);
    server.patch('/date', {
        preHandler: guard_middleware_js_1.Guard.authorize([constants_config_js_1.ROLES.admin, constants_config_js_1.ROLES.user]),
        schema: {
            body: zod_1.z.object({
    ...
    }, checkup_controller_js_1.default.updateDate);
    ...
    }, checkup_controller_js_1.default.batchDelete);
    ...
    }, checkup_controller_js_1.default.batchGet);
    done();
}
